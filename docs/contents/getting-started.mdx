...
<CodeRunner code="shellviz.clear();shellviz.log('hello world');shellviz.markdown('pretty **cool**!')">
<CodeExample language="python" code={`from shellviz import log, markdown
log('hello world')
